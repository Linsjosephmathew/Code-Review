#Here we are importing some of the libraries and modules 
...
#app.models' is used to import the models of the database
...
#FlaskGroup() is used to create commands for managing this application
cli = FlaskGroup(create_app=create_app)

#This is all the user information in json format
user_json = [
	{
		"name": "John Doe",
...
#This is all the product information in json format
product_json = [
	{
...
# The recreate_db() function deleted and then recreated the db 
def recreate_db():
	db.drop_all()
	db.create_all()
	db.session.commit()

#seeder() function re-enters the data into the newly created database
def seeder():
